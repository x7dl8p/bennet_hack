...
export default function Header({ toggleSidebar }: HeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between py-2 px-4 border-b border-zinc-800 dark:border-zinc-800 bg-black/80 dark:bg-black/80 text-white dark:text-white backdrop-blur-md sticky top-0 z-10">
