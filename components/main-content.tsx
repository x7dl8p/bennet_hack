...
export default function MainContent({
  ...
  const categories = ["all", ...Array.from(new Set(mutualFundData.map((fund) => fund.category)))]
  const riskLevels = ["all", ...Array.from(new Set(mutualFundData.map((fund) => fund.riskLevel)))]
      ...
      case "overview":
        return (
          <div className="space-y-4">
            ...
            <FundList funds={filteredFunds} selectedFund={selectedFund} onFundSelect={onFundSelect} />
          </div>
        )
      case "returns":
        return (
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription>Analyze historical and projected returns</CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="historical">
                ...
                <TabsContent value="historical" className="pt-4">
                  <div className="space-y-4">
                    ...
                    <p className="text-zinc-400">Select a fund from the overview to view detailed returns analysis.</p>
                  </div>
                </TabsContent>
                <TabsContent value="projected" className="pt-4">
                  <p className="text-zinc-400">AI-powered return projections will appear here.</p>
                </TabsContent>
                <TabsContent value="comparison" className="pt-4">
                  <p className="text-zinc-400">Compare returns across multiple funds.</p>
                </TabsContent>
              </Tabs>
            </CardContent>
          </Card>
        ...
        return (
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription>Quantify and visualize investment risks</CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="volatility">
                ...
                <TabsContent value="volatility" className="pt-4">
                  <p className="text-zinc-400">Volatility metrics and analysis will appear here.</p>
                </TabsContent>
                <TabsContent value="drawdown" className="pt-4">
                  <p className="text-zinc-400">Maximum drawdown analysis will appear here.</p>
                </TabsContent>
                <TabsContent value="scenarios" className="pt-4">
                  <p className="text-zinc-400">Stress test scenarios will appear here.</p>
                </TabsContent>
              </Tabs>
            </CardContent>
          </Card>
        ...
        return (
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription>RAG-powered analysis and recommendations</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <Textarea
                ...
                <div className="p-4 rounded-md bg-zinc-800 mt-4 min-h-[200px]">
                  <p className="text-zinc-400 text-sm">AI-generated insights will appear here.</p>
                </div>
              </div>
            </CardContent>
          </Card>
  ...
  return <div className="h-full p-6 overflow-y-auto">{renderContent()}</div>
}
